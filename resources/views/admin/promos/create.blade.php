...
<div class="card shadow-sm border-0 p-4">
    ...
    <form action="{{ route('admin.promos.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="cta_url" class="form-control" value="{{ old('cta_url') }}" placeholder="Contoh: /booking atau https://shopee.co.id/...">
        </div>
        <div class="mb-3">
            <label class="form-label">Teks Tombol</label>
            <input type="text" name="cta_text" class="form-control" value="{{ old('cta_text', 'Lihat Promo') }}" placeholder="Lihat Promo">
        </div>
